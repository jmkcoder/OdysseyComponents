...
import SidebarContainerStories, { Default, Themed, Resizable, Collapsible, WithNodeExplorer, CustomHeaderFooter } from './SidebarContainer.stories';
...
<style jsx global>{`
    #story--components-sidebarcontainer--default-inner {
        position: relative;
        height: 400px; /* Adjust the height to make the canvas smaller */
    }
`}</style>
